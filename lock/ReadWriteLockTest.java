...
public class ReadWriteLockTest {
    ...
    public void readSomthing() throws InterruptedException{
        System.out.println(Thread.currentThread().getName() + " try readLock");
        lock.readLock().lock();
        System.out.println(Thread.currentThread().getName() + " lock readlock");
        Thread.sleep(500);
    ...
    public void writeSomething() throws InterruptedException{
        ...
        Thread.sleep(2000);
        System.out.println("writeHoldCount: " + lock.getWriteHoldCount()); //ReadLock WriteLock都是可重入锁，这个是查询当前线程锁了多少次
